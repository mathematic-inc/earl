...
<Cards>
  <Card title="Installation" href="/docs/installation" description="Install earl via script or cargo with optional feature flags." />
  <Card title="Quick Start" href="/docs/quick-start" description="Your first constrained API call in minutes." />
  <Card title="Security Model" href="/docs/security" description="How earl protects secrets, enforces policies, and blocks attacks." />
  <Card title="AI Agent Integration" href="/docs/mcp" description="Expose templates as MCP tools for Claude and other agents." />
  <Card title="Configuration" href="/docs/configuration" description="Network policies, OAuth profiles, and search settings." />
  <Card title="Templates" href="/docs/templates" description="Author and manage HCL template files." />
  <Card title="CLI Reference" href="/docs/commands" description="Complete command reference." />
</Cards>
