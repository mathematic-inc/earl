...
| Action          | Key fields                                                     | Result shape   |
| --------------- | -------------------------------------------------------------- | -------------- |
| `click`         | `ref` or `selector`, `double_click`, `button`, `modifiers`     | `{"ok": true}` |
| `hover`         | `ref` or `selector`                                            | `{"ok": true}` |
| `fill`          | `ref` or `selector`, `text`, `submit`, `slowly`                | `{"ok": true}` |
...
| Action                  | Key fields                                            | Result shape   |
| ----------------------- | ----------------------------------------------------- | -------------- |
| `wait_for`              | `text`, `text_gone`, `time` (seconds), `timeout_ms`  | `{"ok": true}` |
| `verify_text_visible`   | `text`                                                | `{"ok": true}` |
| `verify_element_visible`| `role`, `accessible_name`                             | `{"ok": true}` |
| `verify_list_visible`   | `ref`, `items` (array)                                | `{"ok": true}` |
| `verify_value`          | `ref`, `value`                                        | `{"ok": true}` |
