...
**cargo-binstall — prebuilt executables:**

```bash
cargo binstall --disable-strategies compile earl
```

**mise — direct GitHub releases:**
...
Run `mise install`. These installations do not require Rust, Node.js, or pnpm.
Archives cover x64 and ARM64 on macOS, Linux GNU, Linux musl, and Windows.
