...
### Install the example template

```bash
earl templates install https://raw.githubusercontent.com/brwse/earl/main/examples/bash/system.hcl
```
...
### Install the GitHub template

```bash
earl templates install https://raw.githubusercontent.com/brwse/earl/main/templates/github.hcl
```
