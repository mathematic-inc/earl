...
The `body` block supports six kinds: `json`, `form_urlencoded`, `multipart`, `raw_text`, `raw_bytes_base64`, and `file_stream`. See [Template Schema](/docs/template-schema) for the full field reference.
