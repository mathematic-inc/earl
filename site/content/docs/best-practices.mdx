...
For the full secrets and authentication reference, see [Secrets & Auth](/docs/secrets-and-auth).
...
For the complete guide to environment switching, see [Environments](/docs/environments).
