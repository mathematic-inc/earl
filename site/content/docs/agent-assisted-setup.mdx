...
curl -fsSL https://raw.githubusercontent.com/mathematic-inc/earl/main/skills/development/setup-earl/SKILL.md \
...
```text
Fetch https://raw.githubusercontent.com/mathematic-inc/earl/main/skills/development/setup-earl/SKILL.md
and any files it references under
https://raw.githubusercontent.com/mathematic-inc/earl/main/skills/development/references/
...
**Install.** The agent checks whether `earl` is on PATH. If not, it picks an install method based on the OS — install script for macOS/Linux, PowerShell for Windows, or `cargo binstall --disable-strategies compile earl` — then runs `earl doctor` to verify.
...
[`skills/development/setup-earl/SKILL.md`](https://github.com/mathematic-inc/earl/blob/main/skills/development/setup-earl/SKILL.md) in the Earl repository.
